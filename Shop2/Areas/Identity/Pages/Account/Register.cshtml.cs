...
namespace Shop2.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AppUser { UserName = Input.Email, Email = Input.Email, Name = Input.Name, Surname = Input.Surname, Age = Input.Age, LinqToFacebook = Input.LinqToFacebook, LinqToTelegram = Input.LinqToTelegram };
